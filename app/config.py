...
@dataclass
class Settings:
    app_title: str = os.getenv("APP_TITLE", "Solar ES")
    ...
    growatt_enabled: bool = _env_bool("GROWATT_ENABLED", False)
    growatt_base_url: str = os.getenv("GROWATT_BASE_URL", "").rstrip("/")
    growatt_status_path: str = os.getenv("GROWATT_STATUS_PATH", "")
    growatt_token: str = os.getenv("GROWATT_TOKEN", "")
    growatt_header_name: str = os.getenv("GROWATT_HEADER_NAME", "token")
    growatt_poll_seconds: float = _env_float("GROWATT_POLL_SECONDS", 60.0)
    growatt_timeout_seconds: float = _env_float("GROWATT_TIMEOUT_SECONDS", 15.0)
    growatt_battery_soc_path: str = os.getenv("GROWATT_BATTERY_SOC_PATH", "data.batterySoc")
    growatt_battery_power_path: str = os.getenv("GROWATT_BATTERY_POWER_PATH", "data.batteryPower")
    growatt_battery_temp_path: str = os.getenv("GROWATT_BATTERY_TEMP_PATH", "data.batteryTemp")
    growatt_battery_capacity_path: str = os.getenv("GROWATT_BATTERY_CAPACITY_PATH", "data.batteryCapacity")
    growatt_battery_status_path: str = os.getenv("GROWATT_BATTERY_STATUS_PATH", "data.batteryStatus")

    tesla_enabled: bool = _env_bool("TESLA_ENABLED", False)
    tesla_base_url: str = os.getenv("TESLA_BASE_URL", "https://fleet-api.prd.na.vn.cloud.tesla.com")
    tesla_access_token: str = os.getenv("TESLA_ACCESS_TOKEN", "")
    tesla_vehicle_vins: str = os.getenv("TESLA_VEHICLE_VINS", "")
    tesla_energy_site_id: str = os.getenv("TESLA_ENERGY_SITE_ID", "")
    tesla_poll_seconds: float = _env_float("TESLA_POLL_SECONDS", 300.0)
    tesla_timeout_seconds: float = _env_float("TESLA_TIMEOUT_SECONDS", 20.0)
